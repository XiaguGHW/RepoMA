...
LOG_PATH = LOG_DIR / f"gemini_P1_first20_test_{RUN_TIMESTAMP}.log"
RESULT_PATH = RESULTS_DIR / f"gemini_P1_first20_test_{RUN_TIMESTAMP}.xlsx"
RAW_RESPONSES_PATH = (
    RESPONSES_DIR / f"gemini_P1_first20_responses_{RUN_TIMESTAMP}.jsonl"
)
